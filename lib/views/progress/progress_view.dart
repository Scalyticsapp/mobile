...
class ProgressView
  ...
  @override
  State<ProgressView> createState() =>
      _ProgressViewState();
}

class _ProgressViewState
    extends State<ProgressView> {
  ...
  Widget _buildScanReminder() {
    ...
    if (lastScan == null) {
      return _reminderBanner(
        ...
        text:
            'Kamu belum pernah scan. Yuk mulai scan pertama kamu!',
    ...
    if (daysSince >= 7) {
      return _reminderBanner(
        ...
        text:
            'Sudah waktunya scan minggu ini!',
    ...
    if (daysUntilNext <= 5) {
      return _reminderBanner(
        ...
        text:
            '$daysUntilNext hari lagi waktunya scan.',
