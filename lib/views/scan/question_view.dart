...
class _QuestionViewState extends State<QuestionView> {
  ...
  void _initializeArguments() {
    ...
    diseaseInfo = DiseaseData.getDisease(
          diseaseKey,
        ) ??
                ...
                children: [
                  ...
                  ...currentQuestion.options.asMap().entries.map(
                        (entry) => OptionTile(
                          ...
                          onTap: () {
                            setState(() {
                              answers[currentIndex] = entry.value;
                            });
                          },
                        ),
                      ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selectedAnswer.isNotEmpty ? AppColors.accent : AppColors.s3,
        ...
        child: Center(
          child: Text(
            ...
            style: TextStyle(
              fontWeight: FontWeight.w600,
              color: selectedAnswer.isNotEmpty ? Colors.black : AppColors.muted,
            ),
          ),
        ),
      ),
